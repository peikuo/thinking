...
const config: Config = {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'flow-gradient': 'linear-gradient(90deg, var(--flow-gradient-from), var(--flow-gradient-to))',
				'flow-radial': 'radial-gradient(circle, var(--flow-gradient-from), var(--flow-gradient-to))'
			}
		}
	},
	plugins: [
